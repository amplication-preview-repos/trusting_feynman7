...
@InputType()
class AgentsUpdateManyWithoutAppointmentsItemsInput {
...
export { AgentsUpdateManyWithoutAppointmentsItemsInput as AgentsUpdateManyWithoutAppointmentsItemsInput };
